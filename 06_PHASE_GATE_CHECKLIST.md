...
*v1.11 changes (2026-06-12, operator-approved same day with two clarifying edits): Internal Test Delivery Posture ADOPTED — internal review delivery is labeled, not blocked, for explicitly allowlisted internal-review destinations only; streak wording amended (operator confirmation substitutes for client confirmation during the internal period; production-path runs only). Reference: OPENCLAW_GOV_PROPOSAL_INTERNAL_TEST_DELIVERY_2026-06-12.*
