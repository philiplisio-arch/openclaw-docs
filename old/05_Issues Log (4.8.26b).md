...
#### Current State (UPDATED — 5.6)

✔ Baidu retrieval fully activated (real API — no simulation)  
✔ baidu_status = ok confirmed across multiple runs  
✔ Baidu results flowing through:
  - normalized_results.json  
  - filtered_results.json  
  - retrieval_package.json  

✔ Publisher normalization implemented:
  - Sina Finance, CCTV, Reuters, CNBC correctly labeled  
  - Unknown publisher issue largely resolved  

✔ Low-quality source filtering added:
  - Baijiahao removed at filter stage  

---

#### Remaining Gap

Baidu now contributes real signal, but:

- Relative contribution remains lower than Brave after filtering  
- Some Chinese sources still underrepresented vs Western outlets  
- No source weighting / prioritization yet  

---

#### Updated Focus (Phase 5.6 Continuation)

1. Improve China-source retention quality  
2. Introduce light source weighting (non-destructive)  
3. Monitor Brave vs Baidu contribution balance  
4. Preserve system stability during all upgrades  

---

#### Status

🟡 ACTIVE — shifted from "integration" → "quality optimization"
