...
|----------|-------------|----------|----------|--------|---------|
| Master Document Index | OPENCLAW-MDI-001 | `00_Master_Document_Index (5.13.26).md` | [root] | ACTIVE | This document — navigable index of all system documents |
...
| Document | Document ID | Filename | Location | Status | Purpose |
|----------|-------------|----------|----------|--------|---------|
| Issues Log | OPENCLAW-ISSUES-001 | `03_Issues Log (5.13.26).md` | [root] | OPERATIONAL | Active and recently resolved issues; numbered cumulatively |
| Daily Status | — | `04_DAILY_STATUS (5.13.26).md` | [root] | OPERATIONAL | Current position, system health, next step; **single source of truth for active phase** |
...
| Advisory Memo 010 | OPENCLAW-ADV-010 | `OPENCLAW-ADV-010 (5.11.26).md` | advisory/ | ACTIVE | Documentation improvement plan — rename convention, stale dates, changelog footers, version standardization, archive index |
...
- **advisory/:** OPENCLAW-ADV-NNN sequential; next memo ADV-011
...
*OPENCLAW-MDI-001 | Version 5.13.26 | Last updated: 2026-05-13 | Status: ACTIVE*

*5.13.26 changes: Updated Tier 6 operational document filenames (Issues Log and Daily Status) to (5.13.26); added ADV-010 to Tier 7; updated self-reference filename in Tier 1; updated next advisory memo counter to ADV-011.*
