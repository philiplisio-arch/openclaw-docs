# OPENCLAW — CUMULATIVE ISSUE LOG & FEATURE TRACKING (v3.6)
...
* #23 — Production Integration Risk (NEW — Phase 5.4)
* #21 — Retrieval Stability / Accessibility (MONITOR)
* #22 — Baidu Integration Coverage Gap (UPDATED)
...
* Baidu retrieval integrated (partial — simulated / limited)
...
9. Manual execution dependency → operational bottleneck (NEW — Phase 5.4)
...
### ISSUE #23 — Production Integration Risk (NEW)
...
- system is not truly operational
...
- Existing pipeline still using legacy execution path
...
- One trigger → full pipeline runs
- No manual intervention
- Output delivered to Lark automatically
...
- Baidu execution implemented
- Currently simulated / limited output
- Brave provides majority of signal
...
- Baidu integration not yet fully production-grade
- No weighting / prioritization logic yet
...
- improve Baidu reliability
- validate Chinese-language depth
- integrate additional China-native sources
