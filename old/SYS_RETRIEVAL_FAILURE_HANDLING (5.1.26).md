...
Definition: Scrubber cannot parse citation groups or produces scrubber_report.json with errors.
...
| Scrubber | Cannot parse citation groups | Treat as structural failure; do not pass to validator | Block |
